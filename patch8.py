...
new_footer = '''    <footer class="site-footer" id="footer-contact">
        <div class="footer-content">
            <div class="footer-col logo-col">
                ...
                <p style="margin-bottom: 2rem;">Cuidado consciente y natural para tu piel y cabello.</p>
                ...
                <div class="footer-dev-credit">
                    ...
                    <p class="dev-credit-text">Experiencia digital diseñada por MP Dev Studio.</p>
                </div>
            </div>
