...
new_footer = '''    <footer class="site-footer" id="footer-contact">
        ...
        <section class="developer-credits-section">
            <div class="curarte-studio-footer" aria-label="Créditos y contacto del proyecto">
...
pattern = re.compile(r'<footer class="site-footer" id="footer-contact">.*?</section>', re.DOTALL)
